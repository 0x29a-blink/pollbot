            ...
            >
                ...
                {error && (
                    <motion.div
                        ...
                        className="text-red-400 text-sm text-center bg-red-500/10 py-3 px-4 rounded-md border border-red-500/20 mb-6"
                    >
                        {error === 'oauth_denied' && 'You denied access to your Discord account.'}
                        {error === 'session_expired' && 'Your session has expired. Please sign in again.'}
                        {error !== 'oauth_denied' && error !== 'session_expired' && 'An error occurred. Please try again.'}
                    </motion.div>
                )}
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg text-white font-semibold hover:opacity-90 transition-opacity"
                >
